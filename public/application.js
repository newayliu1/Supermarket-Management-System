...
/***/ function(module, exports, __webpack_require__) {
	...
	var smyAuthEvents = __webpack_require__(12);
	$(function () {
	  authEvents.addHandlers(); //handlers for authenication
	  smyAuthEvents.addHandlers();
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var data_analyst = __webpack_require__(37);
	...
	var onSearch = function onSearch(event) {
	  ...
	  api.search().then(function (response) {
	    ...
	    var product = data_analyst.getProduct(data.product);
	    ui.showProduct(product);
	    return store;
	  }).catch(ui.failure);
	};

	var onCreateInv = function onCreateInv(event) {
	  event.preventDefault();

	  var data = getFormFields(event.target);
	  api.createInv(data).then(function (response) {
	    store.inventories = response;
	    ui.showCreateInvTable(store.inventories);
	    return store;
	  }).then(ui.createInvSuccess).catch(ui.createInvFailure);
	};
	//
	var onCreateOrder = function onCreateOrder(event) {
	  ...
	  api.createOrder(data).then(function (response) {
	    ...
	    return store;
	  }).then(ui.createOrderSuccess).catch(ui.createOrderFailure);
	};
	...
	var onCreateProduct = function onCreateProduct(event) {
	  ...
	  var data = getFormFields(event.target);
	  api.createProduct(data).then(function (response) {
	    store.product = response;
	    ui.showCreateProductTable(store.product);
	    return store;
	  }).then(ui.createProductSuccess).catch(ui.createProductFailure);
	};

	var onExpiredOrder = function onExpiredOrder(event) {
	  event.preventDefault();

	  api.getAllOrders().then(function (response) {
	    store.orders = response.orders;
	    var data = data_analyst.getExpiredOrder(store.orders);
	    ui.showCreateOrderTable(data);
	    return store;
	  }).then(ui.searchExpirationOrderSuccess).catch(ui.failure);
	};

	var onSearchInv = function onSearchInv(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.getInventory(data).then(function (response) {
	    store.inventory = response;
	    ui.showCreateInvTable(store.inventory);
	    return store;
	  }).then(ui.searchInvSuccess).catch(ui.searchInvFailure);
	};

	var onSearchOrder = function onSearchOrder(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.getOrder(data).then(function (response) {
	    store.order = response;
	    ui.showCreateOrderTable(store.order);
	    return store;
	  }).then(ui.searchOrderSuccess).catch(ui.searchOrderFailure);
	};

	var onDeleteOrder = function onDeleteOrder(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.deleteOrder(data).then(ui.deleteSuccess).catch(ui.deleteFailure);
	};

	var onDeleteInv = function onDeleteInv(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.deleteInv(data).then(ui.deleteSuccess).catch(ui.deleteFailure);
	};

	var onUpdatePrice = function onUpdatePrice(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.updatePrice(data).then(function (response) {
	    store.inventory = response;
	    ui.showCreateInvTable(store.inventory);
	    return store;
	...
	var onUpdateSection = function onUpdateSection(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.updateSection(data).then(function (response) {
	    store.inventory = response;
	    ui.showCreateInvTable(store.inventory);
	    return store;
	  }).then(ui.updateSuccess).catch(ui.updateFailure);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createInv = function createInv(data) {
	  return $.ajax({
	...
	var getInventory = function getInventory(data) {
	  return $.ajax({
	...
	var getOrder = function getOrder(data) {
	  return $.ajax({
	...
	var deleteInv = function deleteInv(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/inventories/' + data.id,
	    method: 'DELETE',
	    headers: {
	...
	var updatePrice = function updatePrice(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/inventories/' + data.id,
	    method: 'PATCH',
	    headers: {
	...
	var updateSection = function updateSection(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/inventories/' + data.id,
	    method: 'PATCH',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var searchSucess = function searchSucess() {
	...
	var createProductSuccess = function createProductSuccess() {
	  $('#result-display').text('Product Create Successfully!');
	  $('#result-display').fadeIn(1000).delay(1000).fadeOut(300);
	  $('.input-field').val('');
	};

	var createProductFailure = function createProductFailure() {
	  $('#result-display').text('Product Name Exists in Database OR Invalid Input!');
	  $('#result-display').fadeIn(1000).delay(1000).fadeOut(300);
	  $('.input-field').val('');
	};

	var inventoryTable = __webpack_require__(15);
	var showCreateProductTable = function showCreateProductTable(productData) {
	  $('#table-container').html(inventoryTable({
	...
	var showCreateInvTable = function showCreateInvTable(inventoryData) {
	  var inventoryTable = __webpack_require__(35);
	  $('#table-container').html(inventoryTable({
	...
	var createInvSuccess = function createInvSuccess() {
	  $('#result-display').text('Create Inventory Successfully!');
	  $('#result-display').fadeIn(1000).delay(1000).fadeOut(300);
	  $('.input-field').val('');
	};

	var createInvFailure = function createInvFailure() {
	...
	var showCreateOrderTable = function showCreateOrderTable(orderData) {
	  var inventoryTable = __webpack_require__(36);
	  $('#table-container').html(inventoryTable({
	    orders: orderData
	  }));
	};
	...
	var searchExpirationOrderSuccess = function searchExpirationOrderSuccess() {
	  $('#result-display').text('Search Expiration Order Successfully!');
	  $('#result-display').fadeIn(1000).delay(1000).fadeOut(300);
	  $('.input-field').val('');
	};
	var searchInvSuccess = function searchInvSuccess() {
	  $('#result-display').text('Search Inventory Successfully!');
	  $('#result-display').fadeIn(1000).delay(1000).fadeOut(300);
	  $('.input-field').val('');
	};
	var searchInvFailure = function searchInvFailure() {
	  $('#result-display').text('Invalid Inventory ID!!');
	  $('#result-display').fadeIn(1000).delay(1000).fadeOut(300);
	  $('.input-field').val('');
	};
	var searchOrderSuccess = function searchOrderSuccess() {
	  $('#result-display').text('Search Order Successfully!');
	  $('#result-display').fadeIn(1000).delay(1000).fadeOut(300);
	  $('.input-field').val('');
	};
	var searchOrderFailure = function searchOrderFailure() {
	...
	module.exports = {
	  showCreateInvTable: showCreateInvTable,
	  createInvSuccess: createInvSuccess,
	  createInvFailure: createInvFailure,
	  showCreateOrderTable: showCreateOrderTable,
	  ...
	  searchSucess: searchSucess,
	  showCreateProductTable: showCreateProductTable,
	  createProductFailure: createProductFailure,
	  searchExpirationOrderSuccess: searchExpirationOrderSuccess,
	  searchInvSuccess: searchInvSuccess,
	  searchOrderSuccess: searchOrderSuccess,
	  searchInvFailure: searchInvFailure,
	  searchOrderFailure: searchOrderFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "    <tr>\n      <td data-id=\""
	    ...
	    + "</td>\n      <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.sections : stack1), depth0))
	    + "</td>\n      <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.inventoriesID : stack1), depth0))
	    + "</td>\n      <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.ordersID : stack1), depth0))
	    + "</td>\n    </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<h1>Table</h1>\n<table class=\"table\">\n  <thead>\n    <tr>\n      <th>Product ID</th>\n      <th>Name</th>\n      <th>Sections</th>\n      <th>Inventories ID</th>\n      <th>Orders ID</th>\n    </tr>\n  </thead>\n  <tbody>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.products : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "  </tbody>\n</table>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "    <tr>\n      <td data-id=\""
	    ...
	    + "</td>\n      <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.section : stack1), depth0))
	    + "</td>\n      <td>"
	  ...
	  return "<h1>Table</h1>\n<table class=\"table\">\n  <thead>\n    <tr>\n      <th>Inventory ID</th>\n      <th>Product</th>\n      <th>Section</th>\n      <th>Price</th>\n    </tr>\n  </thead>\n  <tbody>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.inventories : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "  </tbody>\n</table>\n";
	},"useData":true,"useBlockParams":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "    <tr>\n      <td data-id=\""
	    ...
	    + "</td>\n      <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.expiration_date : stack1), depth0))
	    + "</td>\n      <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.order_date : stack1), depth0))
	    + "</td>\n    </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<h1>Table</h1>\n<table class=\"table\">\n  <thead>\n    <tr>\n      <th>Order ID</th>\n      <th>Product</th>\n      <th>Amount</th>\n      <th>Expiration Date</th>\n      <th>Order Date</th>\n    </tr>\n  </thead>\n  <tbody>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.orders : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "  </tbody>\n</table>\n";
	},"useData":true,"useBlockParams":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getProduct = function getProduct(productName) {
	  var product = void 0;
	  store.products.forEach(function (el) {
	    if (el.name === productName) {
	      product = { product: el };
	      var inventories = [];
	      var inventoriesID = [];
	      var ordersID = [];
	      el.inventories.forEach(function (inventory) {
	        inventories.push(inventory.section);
	        inventoriesID.push(inventory.id);
	      });
	      el.orders.forEach(function (order) {
	...
	var getExpiredOrder = function getExpiredOrder(orders) {
	  var today = new Date();
	  var arr = [];
	  today.getDate();
	...
	module.exports = {
	  ...
	  getExpiredOrder: getExpiredOrder
	};
